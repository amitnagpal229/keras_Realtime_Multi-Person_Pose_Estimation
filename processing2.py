...
def get_model_heat_paf(input_image, params, model, model_params):
    ...
    return input_image.shape[0], heatmap_avg, paf_avg

def extract_parts(input_image_shape_0, params, heatmap_avg, paf_avg):
    all_peaks = []
    peak_counter = 0
            ...
            for i in range(n_a):
                for j in range(n_b):
                    ...
                    score_with_dist_prior = sum(score_midpts) / len(score_midpts) + min(
                        0.5 * input_image_shape_0 / norm - 1, 0)
